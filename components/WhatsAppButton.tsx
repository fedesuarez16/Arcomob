...
export default function WhatsAppButton() {
  ...
  return (
    <div ref={containerRef} className="fixed bottom-6 right-6 z-50">
      {isOpen && (
        <div className="absolute bottom-16 right-0 w-72 overflow-hidden rounded-xl bg-white shadow-lg shadow-black/20 ring-1 ring-black/5">
          <p className="bg-[#25D366] px-4 py-3 text-sm font-medium text-white">
      ...
      <button
        ...
        className="flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-lg shadow-black/20 transition-transform duration-200 hover:scale-110 hover:bg-[#1EBE5D] focus:outline-none focus:ring-2 focus:ring-[#25D366] focus:ring-offset-2"
      >
        <svg
