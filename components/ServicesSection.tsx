      ...
      <div className="container mx-auto px-6 lg:px-10 xl:px-16">
        ...
        <div className="mb-8 lg:mb-12">
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-stone-800 mb-4">
            Soluciones Completas de Revestimientos <p className="text-red-600"> Alistonados </p> 
          </h2>
        ...
        >
          {/* Left fade gradient */}
          <div className="absolute left-0 top-0 bottom-4 w-4 bg-gradient-to-r from-white via-white to-transparent z-10 pointer-events-none"></div>
          
          {/* Right fade gradient */}
          <div className="absolute right-0 top-0 bottom-4 w-4 bg-gradient-to-l from-white via-white to-transparent z-10 pointer-events-none"></div>
          
          {/* Scrollable container */}
          <div 
            ref={scrollContainerRef}
            className="flex gap-4 px-4 overflow-x-auto pb-4 scrollbar-hide"
